...
#define CUST_EINT_ALS_SENSITIVE 1
#define CUST_EINT_ALS_POLARITY 0
...
static struct i2c_board_info __initdata i2c_ltr559={ I2C_BOARD_INFO(LTR559_DEV_NAME, 0x23)};
 ...
 */
static int ps_trigger_high = 18;				//yaoyaoqin: trigger up threshold
static int ps_trigger_low = 23;				//yaoyaoqin: trigger low threshold
...
static int __init ltr559_init(void)
{
	...
	i2c_register_board_info(2, &i2c_ltr559, 1);  //xiaoqian, 20120412, add for alsps
